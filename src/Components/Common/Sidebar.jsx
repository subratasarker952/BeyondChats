    ...
    <div className="">
      <div className="p-4 bg-slate-600">
          ...
          <div className="flex justify-between">
            <div className="w-20 h-20 rounded-full m-2 bg-white">
              <img src="" alt="" />
            </div>
            <div>
          ...
          <div className="flex justify-between">
            ...
            <div className="">
              <label className="swap swap-rotate">
                ...
                {/* sun icon */}
                <div className="swap-on fill-current text-xl">
                  <FaChevronDown />
                </div>
      ...
      <div className="bg-gray-800">
        ...
        <Link className="flex justify-start mt-3 text-xl items-center" to={"/calls"}>
          <span className="p-2">
            <FaPhone />
          </span>
          Calls
